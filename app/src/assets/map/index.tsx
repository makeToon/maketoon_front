  ...
  return (
    <svg width={width} height={height} viewBox={`0 0 ${width} ${height}`}>
      <defs>
        {[].map((d, i) => (
          <pattern
            ...
            height="1"
          >
            <image width={d.width} height={d.height} href={d.imgUrl} />
          </pattern>
        ))}
      </defs>
      <g fill={fillColor} stroke={strokeColor}>
        <S.Path
          onClick={() => setAreaHandler("서울특별시")}
          fill={
      ...
      <g fill={fillColor} stroke={strokeColor}>
        ...
        <S.Path
          onClick={() => setAreaHandler("세종특별자치시")}
          fill={
      ...
      <g fill={fillColor} stroke={strokeColor}>
        ...
        />
        <S.G onClick={() => setAreaHandler("군산시")}>
          {" "}
          fill=
